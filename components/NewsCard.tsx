...
const NewsCard: React.FC<News> = ({ title, text, link }) => {
  return (
    <Link target="_blank" href={link} style={{ textDecoration: 'none' }}>
      <div className="max-w-md p-6 m-3 bg-inherit large-inner-shadow hover:shadow-lg transition-shadow duration-300 md:h-80 lg:h-56 h-96" style={{borderRadius: "15px"}}>
