...
async function getById(jsonObject: Record<string, any>, id: string): Promise<any | undefined> {
...
export default async function ArticlePage({ params: { id } }: Props) {
    try {
        const filePath = path.join(process.cwd(), 'src/app/data/articlesData.json');
