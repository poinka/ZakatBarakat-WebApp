...
const NewsCard: React.FC<News> = ({ title, text, link }) => {
  return (
    <Link target="_blank" href={link} style={{ textDecoration: 'none' }}>
      <div className="w-11/12 max-w-md p-6 m-5 bg-inherit large-inner-shadow hover:shadow-lg transition-shadow duration-300 md:h-52 h-72" style={{borderRadius: "15px"}}>
