    ...
    return (
        ...
        <div className="flex justify-center pt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-screen-lg "> 
                ...
                <Link key={index} href={fund.url} className="bg-white shadow-xl p-6 mb-6 md:max-w-md w-3/4 m-auto hover:scale-105 md:h-80 lg:h-56 h-80" style={{borderRadius: "15px"}} >
                    <div>
